...
router.get('/:projectId/members', authMiddleware, projectController.getProjectMembersController);

// add validation for req params, middleware function 
router.post('/:projectId/members', authMiddleware, projectController.addProjectMembersController);

// add validation for req params, middleware function 
// DELETE /api/projects/:projectId/members/:profileId - Remove a member from a project
router.delete('/:projectId/members/:profileId', authMiddleware, projectController.removeMemberFromProjectController);
